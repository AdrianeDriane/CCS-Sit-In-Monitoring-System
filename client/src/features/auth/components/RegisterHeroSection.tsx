...
const features: FeatureItem[] = [
  {
    ...
    description: "Track availability across all computer labs",
  },
  {
    icon: "history",
    title: "Session History",
    description: "Keep records of all your sit-in activities",
  },
  {
    icon: "notifications",
    title: "Instant Notifications",
    description: "Get updates on lab schedules and announcements",
  },
];
      ...
      <div className="relative z-10 flex flex-col justify-between p-12 w-full text-white">
        ...
        <div className="mb-12">
          ...
          <p className="text-lg text-left text-white/80 max-w-md leading-relaxed">
            Register your account to start tracking sit-in sessions, access
            computer labs, and stay connected with the College of Computer
            Studies community.
          </p>
